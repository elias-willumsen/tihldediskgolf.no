...
const DATA: Record<string, RoundRow[]> = {
  r1: [
    { player: "Ola", score: 62, toPar: +2, course: "Dragvoll", date: "2025-09-18" },
    { player: "Kari", score: 58, toPar: -2, course: "Dragvoll", date: "2025-09-18" },
    { player: "Nils", score: 60, toPar: 0, course: "Dragvoll", date: "2025-09-18" },
  ],
  r2: [
    { player: "Ola", score: 55, toPar: -5, course: "Follo", date: "2025-10-01" },
    { player: "Kari", score: 57, toPar: -3, course: "Follo", date: "2025-10-01" },
    { player: "Nils", score: 62, toPar: +2, course: "Follo", date: "2025-10-01" },
  ],
  r3: [
    { player: "Ola", score: 61, toPar: +1, course: "Rotvoll", date: "2025-10-05" },
    { player: "Kari", score: 59, toPar: -1, course: "Rotvoll", date: "2025-10-05" },
    { player: "Nils", score: 63, toPar: +3, course: "Rotvoll", date: "2025-10-05" },
  ],
};
    ...
    <div className="w-full max-w-3xl rounded-2xl border border-white/10 bg-white/5 p-4 shadow-2xl backdrop-blur-xl ring-1 ring-white/10">
      ...
      <div className="rounded-xl border border-white/10 bg-black/20 p-3 shadow-inner">
            ...
            <tbody>
              {rows.map((r, i) => (
                ...
                >
                  ...
                  <td className={`px-3 py-2 ${r.toPar < 0 ? "text-emerald-300" : r.toPar > 0 ? "text-rose-300" : "text-white/80"}`}>
        ...
        <div className="mt-3 flex items-center justify-between text-xs text-white/60">
          <span>
            Viser <strong className="text-white">{rows.length}</strong> resultater
          </span>
